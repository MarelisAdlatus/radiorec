...
public class StationDialog extends javax.swing.JDialog {
    ...
    private ProgramSettingsDialog programSettingsDialog;
    ...
    private void initComponents() {
        ...
        setTitle(bundle.getString("StationDialog.title")); // NOI18N
        setResizable(false);

        contentPanel.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));

        jLabel1.setText(bundle.getString("StationDialog.jLabel1.text")); // NOI18N

        jLabel2.setText(bundle.getString("StationDialog.jLabel2.text")); // NOI18N

        jLabel6.setText(bundle.getString("StationDialog.jLabel6.text")); // NOI18N

        recordButtonGroup.add(recordManuallyRadioButton);
        recordManuallyRadioButton.setText(bundle.getString("StationDialog.recordManuallyRadioButton.text")); // NOI18N

        recordButtonGroup.add(recordStreamRadioButton);
        recordStreamRadioButton.setText(bundle.getString("StationDialog.recordStreamRadioButton.text")); // NOI18N
        recordStreamRadioButton.setEnabled(false);

        recordButtonGroup.add(recordProgramRadioButton);
        recordProgramRadioButton.setText(bundle.getString("StationDialog.recordProgramRadioButton.text")); // NOI18N
        recordProgramRadioButton.setEnabled(false);
        ...
        cancelButton.setText(bundle.getString("StationDialog.cancelButton.text")); // NOI18N
        ...
        okButton.setText(bundle.getString("StationDialog.okButton.text")); // NOI18N
        ...
        programSettingsButton.setText(bundle.getString("StationDialog.programSettingsButton.text")); // NOI18N
    ...
    private void okButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_okButtonActionPerformed
        getDialog();
        if (programSettingsDialog != null) {
            if (programSettingsDialog.resultOk) {
                programSettingsDialog.getDialog();
            }
            programSettingsDialog.dispose();
        }
    ...
    private void programSettingsButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_programSettingsButtonActionPerformed
        if (programSettingsDialog == null) {
            programSettingsDialog = new ProgramSettingsDialog(null, station);
            programSettingsDialog.setModal(true);
            programSettingsDialog.setAlwaysOnTop(true);
            programSettingsDialog.setLocationRelativeTo(null);
            programSettingsDialog.setDefaultCloseOperation(WindowConstants.HIDE_ON_CLOSE);
        }
